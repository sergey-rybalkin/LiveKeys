/* -------------------------------------------------------------------------------------------------
 * DummyTextGenerator.cpp - implementation file for CDummyTextGenerator hotkeys handler that inserts
 * dummy lorem ipsum text into the active window.
 *
...
BOOL CDummyTextGenerator::Initialize ( BYTE bHandlerID , 
                                       HWND hwndMainWindow , 
                                       HINSTANCE hInstance ,
