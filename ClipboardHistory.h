...
public:
    ...
    // Get and set accessors for m_hwndNextChain
    HWND GetNextWindowInChain ( ) ;
    VOID SetNextWindowInChain ( HWND hwndNextChain ) ;

    // Is called when main window receives WM_DRAWCLIPBOARD message
    VOID NotifyDrawClipboard ( UINT uMsg , WPARAM wParam , LPARAM lParam ) ;
