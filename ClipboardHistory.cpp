...
BOOL CClipboardHistory::Initialize(
    BYTE bHandlerID,
    HWND hwndMainWindow,
    HINSTANCE hInstance,
    FPN_REGISTER_HOTKEY fpnRegisterHotkey)
{
    ...
    if (!AddClipboardFormatListener(hwndMainWindow))
        return FALSE;
...
VOID CClipboardHistory::ShutDown(FPN_UNREGISTER_HOTKEY fpnUnregisterHotkey)
{
    ...
    RemoveClipboardFormatListener(m_hwndMainWindow);
    fpnUnregisterHotkey(m_bHandlerID, m_bShowHistoryHotkeyID);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
// Is called when main window receives WM_CLIPBOARDUPDATE message. It means that clipboard content has
// changed and we need to save it.
VOID CClipboardHistory::NotifyClipboardUpdate(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
